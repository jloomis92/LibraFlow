...
{
    /// <summary>
    /// Interaction logic for MembersCsvImportDialog.xaml
    /// </summary>
    public partial class MembersCsvImportDialog : Window, INotifyPropertyChanged
    {
        ...
        public List<Member> ImportedMembers { get; private set; }

        public event PropertyChangedEventHandler PropertyChanged;

        public MembersCsvImportDialog()
        {
            InitializeComponent();
            DataContext = this;
        ...
        private void DownloadTemplate_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    File.WriteAllText(saveFileDialog.FileName, CsvImportService.GetMembersCsvTemplate());
        ...
        private async void Import_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                await Task.Run(() =>
                {
                    ImportedMembers = CsvImportService.ParseMembersFromCsv(_selectedFilePath);
                });

                if (ImportedMembers == null || !ImportedMembers.Any())
                {
                    System.Windows.MessageBox.Show("No valid members found in the CSV file.", "No Data", 
                        MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }

                var result = System.Windows.MessageBox.Show(
                    $"Found {ImportedMembers.Count} members to import. Continue?", 
                    "Confirm Import", 
